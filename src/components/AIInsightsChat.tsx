...
export function AIInsightsChat({ campaignData, leadData, analysisContext }: AIInsightsChatProps) {
  ...
  const suggestedQuestions = [
    "What's causing the highest CPL?",
    "Which leads should I prioritise?",
    "How can I reduce wasted spend?",
          ...
          {messages.length === 0 ? (
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground text-center">
                Ask questions about your campaigns and leads
              </p>
        ...
        <div className="p-4 border-t">
          <div className="flex gap-2">
            <Input
              ...
              disabled={isLoading || (campaignData.length === 0 && leadData.length === 0)}
              className="flex-1"
            />
            <Button 
              onClick={sendMessage} 
