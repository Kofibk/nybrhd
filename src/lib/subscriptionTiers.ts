...
export const SUBSCRIPTION_TIERS: Record<SubscriptionTier, SubscriptionTierConfig> = {
  access: {
    ...
    buyerDatabaseDescription: 'Access to qualified buyers with scores 50-69. Our AI scores buyers 0-100 based on budget, timeline, and engagement.',
  ...
  growth: {
    ...
    buyerDatabaseDescription: 'Access to all qualified buyers scoring 50+. Higher scores mean stronger purchase intent.',
  ...
  enterprise: {
    ...
    buyerDatabaseDescription: 'Exclusive first refusal on high-intent buyers scoring 80+. These are your hottest, most ready-to-buy leads.',
